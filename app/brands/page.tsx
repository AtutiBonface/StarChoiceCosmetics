    ...
    <div className="w-full mt-28 md:mt-38">
      ...
      <div className="w-full bg-[#A9BA9D]">
        <div className="max-w-7xl mx-auto px-4 py-2">
          <div className="flex items-center gap-2 text-sm text-[#333333]">
            ...
            <span className="text-pink-600">Shop by Brand</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="text-center mb-4">
          <h1 className="text-3xl font-bold text-[#333333] mb-4">Our Beauty Brands</h1>
            ...
            >
              <div className="bg-white p-4 rounded-md shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden relative">
                ...
                <div className="text-center mt-3">
                  <h3 className="font-medium text-[#333333] group-hover:text-pink-600 transition-colors truncate">
                    {brand.name}
                  </h3>
        ...
        {/* Brand Promise */}
        <div className="mt-16 text-center bg-pink-50 border border-pink-100 rounded-[1px] p-8">
