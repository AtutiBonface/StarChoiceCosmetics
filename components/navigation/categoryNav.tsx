...
const categories = [
  ...
  { id: 2, name: "All Brands", href: "/brands" , hasDropdown: false},
...
const CategoryNav = () => {
  ...
  return (
    <nav className=" border-medium bg-primary h-12">
      <div className="max-w-7xl mx-auto overflow-hidden">
        <div className="mx-auto px-2 flex items-center justify-between">
              ...
              {categories.map((category) => (
                <Link
                  ...
                  className={`
                    ...
                    hover:text-accent-1 transition-colors relative flex items-center gap-1
                    ${activeCategory === category.id ? 'text-accent-1' : 'text-primary'}
                  `}
          ...
          <div className="flex items-center gap-2 text-sm text-primary cursor-pointer hover:text-accent-1 transition-colors shrink-0">
            <MapPin size={16} />
